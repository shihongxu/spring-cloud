package com.axu.springcloudribbonclient.command;

import com.netflix.hystrix.*;
import org.springframework.web.client.RestTemplate;

/**
 * @ClassName CommandForIndex
 * @Description spring cloud hystrix 断路器
 * @Author Axu
...
public class CommandForIndex extends HystrixCommand<Object>{
    ...
    public CommandForIndex(String id, RestTemplate restTemplate) {
        ...
        super(Setter
                ...
                .withGroupKey(HystrixCommandGroupKey.Factory.asKey("AxuHello-Group"))
                ...
                .andThreadPoolKey(HystrixThreadPoolKey.Factory.asKey("AxuHello-ThreadPool"))
                // command 熔断相关参数配置
...
//                       .withMaxQueueSize(2)
    ...
    protected Object run() throws Exception {
        ...
        Object result =  template.getForObject("http://helloclient/user/getuser?id="+id+"",Object.class);
        System.out.println(
